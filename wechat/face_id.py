...
def access_api(img):
    ...
    for obj in res['data']['face_list']:
        ...
        if len(res['data']['face_list']) > 1:  # 检测到多个人脸，就把信息写入人脸框内
            ...
            draw.text((x + 10, y + 10), f'性别 :{gender}', (76, 176, 80), font=font)
            ...
            draw.text((x + w + 10, y + 10), f'性别 :{gender}', (76, 176, 80), font=font)
        ...
        cv2.imwrite(f'faces/{os.path.basename(img)}', cv2img)
    return 'success'